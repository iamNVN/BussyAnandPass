...
(function () {
            ...
            if (editorElement) {
              ...
              async function getAnswerFromAI() {
                try {
                  ...
                  const requestEvent = new CustomEvent('BussyAnandPass_REQUEST_CODE_TYPED', {
                    detail: {
                  ...
                  console.log('[exam.js] Dispatched BussyAnandPass_REQUEST_CODE_TYPED event');
                } catch (error) {
  ...
  window.addEventListener('BussyAnandPass_INSERT_CODE', function (event) {
  ...
  window.addEventListener('BussyAnandPass_INSERT_CODE_TYPED', function (event) {
